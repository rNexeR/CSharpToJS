...
namespace CStoJS.Tests
{
    public class OperatorsAndSymbolsTest
    {
        ...
        public void IncrementOperators(){
            ...
            var expectedTypes = new TokenType[]{TokenType.OP_INC_PP, TokenType.OP_INC_MM, TokenType.OP_ASSIGN_PLUS};
        ...
        public void AsIsOperators(){
            ...
            var expectedTypes = new TokenType[]{TokenType.AS_KEYWORD, TokenType.IS_KEYWORD};
