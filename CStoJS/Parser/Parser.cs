...
namespace CStoJS.ParserLibraries
{
    public partial class Parser
    {
        ...
        private TokenType[] types, builtInTypes; 
        ...
        private TokenType[] jump_statements, selection_statements, iteration_statements, bits_operators;
        ...
        public void InitializeArrays(){
            this.builtInTypes = new TokenType[]{TokenType.INT_KEYWORD, TokenType.CHAR_KEYWORD, TokenType.STRING_KEYWORD, TokenType.FLOAT_KEYWORD, TokenType.BOOL_KEYWORD};
            this.types = new TokenType[]{ TokenType.ID }.Concat(builtInTypes).ToArray();
            ...
            this.assignment_operators = new TokenType[]{ TokenType.OP_ASSIGN, TokenType.OP_ASSIGN_PLUS, TokenType.OP_ASSIGN_MINUS, TokenType.OP_ASSIGN_MULTIPLICATION, TokenType.OP_ASSIGN_DIVISION, TokenType.OP_ASSIGN_MODULO, TokenType.OP_ASSIGN_AND, TokenType.OP_ASSIGN_OR, TokenType.OP_ASSIGN_XOR, TokenType.OP_ASSIGN_SHIFT_LEFT, TokenType.OP_ASSIGN_SHIFT_RIGHT };
            ...
            this.bits_operators = new TokenType[]{TokenType.OP_BITS_AND, TokenType.OP_BITS_COMPLEMENT, TokenType.OP_BITS_OR, TokenType.OP_BITS_XOR };
            this.expression_operators = is_as_operators.Concat(multiplicative_operators).Concat(shift_operators).Concat(equality_operators).Concat(relational_operators).Concat(assignment_operators).Concat(unary_operators).Concat(additive_operators).Concat(literals).Concat(types).Concat(new TokenType[]{ TokenType.PAREN_OPEN, TokenType.NULL_KEYWORD, TokenType.NEW_KEYWORD, TokenType.THIS_KEYWORD, TokenType.BASE_KEYWORD, TokenType.OP_HIERARCHY, TokenType.OP_NULL_COALESCING, TokenType.OP_TERNARY }).Concat(this.bits_operators).ToArray();
        
            this.increment_decrement_operators = new TokenType[]{ TokenType.OP_INC_MM, TokenType.OP_INC_PP };
            this.unary_expression_options = new TokenType[]{ TokenType.PAREN_OPEN,TokenType.NEW_KEYWORD, TokenType.ID, TokenType.THIS_KEYWORD, TokenType.BASE_KEYWORD};
